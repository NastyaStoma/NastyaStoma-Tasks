    ...
    for (var j = 0; j < weeks; j++) {
        ...
        for (var i = 0; i < 7; i++) {
            ...
            input.onclick = function() {
    			document.getElementById('PickerInput').innerHTML = this.value + '.' + Number(CurrMonth + 1) + '.' + CurrYear;
				}
            input.onmouseover = function() {
                this.style.backgroundColor = '#B5D0D9';
                if (this.value == CurrDay) {
                    this.style.backgroundColor = '#1A86AD';
                }
                if (this.value == ' ') {
            ...
            input.onmouseout = function() {
                ...
                if (this.value == CurrDay) {
                    this.style.backgroundColor = '#16ACE3';
                }
                if (this.value == ' ') {
