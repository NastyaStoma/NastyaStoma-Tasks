...
DatePickerForm.type = 'submit';
DatePickerForm.className = "PickerForm";
document.body.appendChild(DatePickerForm);
var DatePickerInput = document.createElement('div');
DatePickerInput.id = "PickerInput";
DatePickerForm.appendChild(DatePickerInput);
DatePickerForm.style.display = 'flex';
DatePickerInput.style.height = '40px';
DatePickerInput.style.width = '75px';
DatePickerInput.style.paddingLeft = '15px';
DatePickerInput.style.paddingRight = '15px';
DatePickerInput.style.backgroundColor = '#DCDCDC';
DatePickerInput.style.borderRadius = '5px';
